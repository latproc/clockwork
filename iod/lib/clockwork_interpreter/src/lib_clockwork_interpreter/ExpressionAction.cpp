        ...
        case ExpressionActionTemplate::opSet:
            if (rhs.kind == Value::t_symbol) {
                ...
                if (rhs_v == SymbolTable::Null) {
                    ...
                    DBG_MSG << owner->getName() << " dereferenced property "
                            << rhs << " and found " << rhs_v << "\n";
...
ExpressionActionTemplate::ExpressionActionTemplate(CStringHolder var,
                                                   opType oper)
...
void ExpressionActionTemplate::toC(std::ostream &out,
