...
struct SetOperationActionTemplate : public ActionTemplate {
    ...
    SetOperationActionTemplate(Value num, Value a, Value b, Value destination,
                               Value property, SetOperation op, Predicate *pred,
                               bool remove, Value start = -1, Value end = -1);
...
struct SetOperationAction : public Action {
    SetOperationAction(MachineInstance *m,
