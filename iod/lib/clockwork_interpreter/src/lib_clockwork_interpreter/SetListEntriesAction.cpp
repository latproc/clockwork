...
SetListEntriesActionTemplate::SetListEntriesActionTemplate(Value source,
                                                           Value destination)
...
SetListEntriesAction::SetListEntriesAction(
    MachineInstance *m, const SetListEntriesActionTemplate *dat)
