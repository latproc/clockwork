...
ControlSystemMachine::ControlSystemMachine()
    : state(s_unknown), ethercat_machine(0), activate_requested(false), deactivate_requested(false),
      ecat_last_synced(0) {
...
#else
/* conditions */
bool ControlSystemMachine::c_connected() const { return ECInterface::master_state.link_up; }
...
bool ControlSystemMachine::c_active() const { return c_connected() && ECInterface::active; }
#endif
