...
IfCommandAction::IfCommandAction(MachineInstance *mi, IfCommandActionTemplate *t)
...
IfElseCommandAction::IfElseCommandAction(MachineInstance *mi, IfElseCommandActionTemplate *t)
    : Action(mi), condition(t->condition) {
    command = dynamic_cast<MachineCommand *>(t->command->factory(mi));
