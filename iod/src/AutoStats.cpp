...
AutoStatStorage::AutoStatStorage(const char *time_name, const char *rate_name,
    ...
    : start_time(0), last_update(0), total_polls(0), total_time(0), total_delays(0),
      rate_property(0), time_property(0), reset_point(reset_every) {
    if (time_name) {
...
const int64_t *AutoStatStorage::setupPropertyRef(const char *machine_name,
