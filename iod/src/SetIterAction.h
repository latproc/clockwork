...
struct SetIterActionTemplate : public ActionTemplate {
    ...
    SetIterActionTemplate(const std::string &name, Value val, Value pos = -1, bool before = false,
                          bool expand = false);
...
struct SetIterAction : public Action {
    SetIterAction(MachineInstance *m, const SetIterActionTemplate *dat, const Value pos,
