...
Action::Status CopyPatternAction::checkComplete() {
	return Complete;
}
...
Action::Status CopyAllPatternAction::checkComplete() {
	return Complete;
}
...
Action::Status ExtractPatternAction::checkComplete() {
	return Complete;
}
...
Action::Status ExtractAllPatternAction::checkComplete() {
	return Complete;
}
...
Action::Status ReplacePatternAction::checkComplete() {
	return Complete;
}
...
Action::Status ReplaceAllPatternAction::checkComplete() {
	return Complete;
}
