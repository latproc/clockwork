...
class Logger::Internals {
  public:
    ...
    // dummy_output is a value (not a pointer). Do not pass 0 here: that used to
    // mean "null pointer" and now constructs a stringstream from a null C string.
    Internals() : log_level(None), log_stream(&std::cout) {}
};
