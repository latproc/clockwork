...
EXTRAINCS = -I../../../stage/include -I/opt/latproc/include -I/opt/local/include -I/usr/local/include
EXTRALIBS = -L../../../stage/lib -L/opt/latproc/lib -L/opt/local/lib -L/usr/local/lib
...
iod:	iod.o IODCommand.h ECInterface.o IOComponent.o Message.o MessagingInterface.o anet.o \
			...
			Logger.o State.o cJSON.o options.o MachineInstance.o Plugin.o \
	...
	$(CC) -o $@ iod.o $(LDFLAGS) \
			...
			MachineInstance.o Plugin.o cwlang.tab.o cwlang.yy.o Scheduler.o $(TOOLLIB) \
...
beckhoffd:	beckhoffd.cpp IODCommand.h ECInterface.o IOComponent.o Message.o MessagingInterface.o anet.o \
			...
			CallMethodAction.o MessageLog.o \
	...
	$(CC) -o $@ beckhoffd.cpp $(LDFLAGS) \
			...
			Logger.o State.o cJSON.o options.o MachineInstance.o Plugin.o Dispatcher.o \
			dynamic_value.o value.o symboltable.o Scheduler.o MessageLog.o \
