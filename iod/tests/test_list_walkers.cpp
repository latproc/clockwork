...
#ifndef LIST_WALKER_LIB_DIR
#error LIST_WALKER_LIB_DIR must be set
#endif
#ifndef LIST_WALKER_ROTATE_LPC
#error LIST_WALKER_ROTATE_LPC must be set
#endif
#ifndef LIST_WALKER_GRID_LPC
#error LIST_WALKER_GRID_LPC must be set
#endif
...
const char *kLibDir = LIST_WALKER_LIB_DIR;
const char *kRotateLpc = LIST_WALKER_ROTATE_LPC;
const char *kGridLpc = LIST_WALKER_GRID_LPC;
...
class ListWalkersTest : public ::testing::Test {
  protected:
    static void SetUpTestSuite() {
        ...
        auto add = [&](const std::string &p) { files.push_back(p); };
        add(std::string(kFixDir) + "/systemexec_stub.lpc");
        add(std::string(kLibDir) + "/generic_control.lpc");
        add(std::string(kLibDir) + "/generic_flag.lpc");
        add(std::string(kLibDir) + "/generic_panel.lpc");
        add(kRotateLpc);
        add(kGridLpc);
        add(std::string(kFixDir) + "/list_walkers.lpc");
